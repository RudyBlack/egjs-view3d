...
export abstract class View3DEffect {
  ...
  public abstract init(view3D: View3D): Promise<void>;
...
export type EffectCallback = (p: { renderer: THREE.WebGLRenderer; camera: THREE.PerspectiveCamera; scene: THREE.Scene, model: Model | null; canvasSize: THREE.Vector2 }) => PassType | View3DEffect;

export type SetCustomEffectParam = (p: { renderer: THREE.WebGLRenderer; camera: THREE.PerspectiveCamera; scene: THREE.Scene, model: Model | null; canvasSize: THREE.Vector2 }) => Composer;
