...
<div className="columns">
  <div className="column is-6">
    <PostProcessing src={"/egjs-view3d/model/shelf.glb"} initialZoom={20} yaw={330} pitch={15}/>
  </div>
  <div className="column is-6">
    <PostProcessing src={"/egjs-view3d/model/shelf.glb"} effectType="basic" initialZoom={20} yaw={330} pitch={15}/>
  </div>
</div>
